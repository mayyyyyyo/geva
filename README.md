...
/* PERBAIKAN: Izinkan scroll di body agar tidak ada scrollbar di dalam kartu */
html, body{
  min-height: 100%;
  width: 100%;
}
...
body{
  ...
  background-attachment: fixed; /* Menjaga background tetap diam saat di-scroll */
  color:white;
  padding:40px 16px; /* Memberi ruang di atas & bawah */
  overflow-x: hidden;
  overflow-y: auto;
}
...
.card{
  ...
  /* PERBAIKAN: Hapus max-height dan overflow agar kartu memanjang */
  overflow: visible; 
